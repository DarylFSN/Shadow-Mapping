...
struct SurfaceShader : Shader {
    ...
    glm::mat4 modelviewLS = glm::mat4(1.0f); GLuint modelviewLS_loc;
    ...
    void initUniforms(){
        ...
        modelviewLS_loc = glGetUniformLocation( program, "modelviewLS" );
    ...
    void setUniforms(){
        ...
        glUniformMatrix4fv(modelviewLS_loc, 1, GL_FALSE, &modelviewLS[0][0]);
