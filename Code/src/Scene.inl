...
void Scene::init(void) {
    ...
    model["floor"]->material = material["silver"];

    // Create a light palette
    light["sun"] = new Light;
    light["sun"]->position = vec4(3.0f, 2.0f, 1.0f, 1.0f) * 1.75f;
    ...
    camera->eye_default = vec3(0.0f, 1.0f, 5.0f);//vec3(3.0f, 2.0f, 1.0f) * 1.75f; //vec3(0.0f, 1.0f, 5.0f); 
    camera->up_default = vec3(0.0f, 1.0f, 0.0f);
    camera->reset();

    glm::mat4 modelview = glm::lookAt(glm::vec3(light["sun"]->position), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f)) * glm::mat4(1.0f);
    ...
    shader->initUniforms();
    shader->modelviewLS = modelview;
    shader->projectionLS = projection;
}